export function BlogSkeleton() {
    return (
        <section className="w-full py-16 md:py-24" aria-label="Loading blog posts">
                            ...
                            >
                                ...
                                <div className="p-5">
                                    <div className="flex gap-2 mb-3">
                                        <div className="h-5 w-16 rounded-full" style={{ background: "var(--bg-tertiary)" }} />
                                        <div className="h-5 w-16 rounded-full" style={{ background: "var(--bg-tertiary)" }} />
                                    </div>
                                    <div className="h-5 w-3/4 rounded-lg mb-2" style={{ background: "var(--bg-tertiary)" }} />
                                    ...
                                    <div className="h-3 w-24 rounded-lg" style={{ background: "var(--bg-tertiary)" }} />
                                </div>
                            </div>
                        ))}
                    </div>
